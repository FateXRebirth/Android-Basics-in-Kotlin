...
class OrderViewModel : ViewModel() {
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        // TODO: if _subtotal.value is not null subtract the previous accompaniment price from the
        //  current subtotal value. This ensures that we only charge for the currently selected
        //  accompaniment.
        if(_subtotal.value != null) {
